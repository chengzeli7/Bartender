...
public final class ItemIngredientBinding implements ViewBinding {
  ...
  private ItemIngredientBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView ingredientAmount, @NonNull TextView ingredientName) {
  ...
  public static ItemIngredientBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemIngredientBinding((ConstraintLayout) rootView, ingredientAmount,
          ingredientName);
    }
